...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    @Override
    public void process(ByteBuffer data, FrameMetadata frameMetadata, com.example.workflow.common.GraphicOverlay graphicOverlay) throws FirebaseMLException {
        latestImage = data;
    ...
    @Override
    public void process(Bitmap bitmap, com.example.workflow.common.GraphicOverlay graphicOverlay) {
